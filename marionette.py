...
LEVELS = [
    ...
    _L(
        ...
        trolls=[
            ...
            ("disappear_after_step",
             [(x, 15) for x in range(8, 12)] +
             [(x, 15) for x in range(15, 19)], 0.4),
        ],
    ),
    ...
    _L(
        ...
        trolls=[
            ("ambush_floor_drop", 16, 28, 6, 0),
            ("ambush_floor_drop", 16, 28, 8, 0),
            ("ambush_floor_drop", 16, 28, 10, 0),
            ("ambush_floor_drop", 16, 28, 12, 0),
    ...
    _L(
        ...
        trolls=[
            ...
            ("ambush_floor_drop", 6, 28, 4, 0),
            ("ambush_floor_drop", 6, 28, 8, 0),
        ],
    ),
